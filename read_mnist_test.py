...
if __name__ == "__main__":
    ...
    file1 = 'C:/Users/28012/Desktop/Statistical Learning/KNN/dataset/MNIST/t10k-images.idx3-ubyte'
    file2 = 'C:/Users/28012/Desktop/Statistical Learning/KNN/dataset/MNIST/t10k-labels.idx1-ubyte'
    ...
    f_train_img = open("Data_test_images.txt", "w")
    num = len(imgs)
    print(num)
    num = int(num)
    for i in range(num):
